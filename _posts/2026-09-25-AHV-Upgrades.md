...
To help avoid these issues, Nutanix introduced a second mode of upgrades called [reimage-based](https://portal.nutanix.com/page/documents/details?targetId=Life-Cycle-Manager-Guide-v3_4:top-ahv-upgrade-specifications-c.html) to massively increase the reliability of upgades that changed large components of the system back in 2023. Nutanix then selected which mode was going to be used based on how much change was in the underlying hypervisor.
